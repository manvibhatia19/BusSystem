...
public final class singup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            First Name: <input type=\"text\" name=\"fname\" required><br><br>\n");
      out.write("            Last Name: <input type=\"text\" name=\"lname\" required><br><br>\n");
      out.write("            Email: <input type=\"email\" name=\"email\" required><br><br>\n");
      out.write("            Username: <input type=\"text\" name=\"uname\" required><br><br>\n");
      out.write("            Account Type: <select name=\"acco\">\n");
      out.write("                <option>Student/Faculty</option>\n");
      out.write("\t\t<option>Staff</option>\n");
      out.write("\t\t<option>Admin</option>\n");
      out.write("            </select>\n");
      out.write("            Password: <input type=\"password\" name=\"pass\" required><br><br>\n");
      out.write("            Confirm Password: <input type=\"password\" name=\"cpass\" required><br><br>\n");
