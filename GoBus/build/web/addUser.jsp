...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h4>First Name: <input type="text" name="fname" placeholder="Enter First Name" required><br><br>
		...
		<option name="Admin" value="Admin">Admin</option>
            ...
            <input style="cursor: pointer;" type="submit" value="Add User"><br><br>
        </form>
            <% } %>
            </div>
