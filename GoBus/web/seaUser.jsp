...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <% if(uname!=null){ %>
            <form action="SeaUserServlet" method="post">
            <h4>Username: <input type="text" name="uname" placeholder="Enter Exisiting Username" pattern="(?=.*[a-z])^[^-\s]{8,}" title="Must not contain spaces and contain all lowercase letters, at least 8 or more characters" required><br><br>
            <input style="cursor: pointer;" type="submit" value="Search User"><br><br>
        </form>
            <% } %>
            </div>
