...
<html>
    ...
    <body>
        ...
        <table class=".table-striped">
            ...
            %>
            <tr>
                <td><%= records.get(i).getFname()%></td>
                <td><%= records.get(i).getLname()%></td>
                <td><%= records.get(i).getEmail()%></td>
                <td><%= records.get(i).getUname()%></td>
                <td><%= records.get(i).getAcco()%></td>
            </tr>
            <%
                }
            }
